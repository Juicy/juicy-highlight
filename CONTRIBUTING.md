...
- Make a local clone of this repo: `git clone git@github.com:Juicy/juicy-highlight.git`

In order to develop it locally we suggest to use [polyserve](https://npmjs.com/polyserve) tool to handle bower paths gently.

0. Go to the repo's directory: `cd juicy-highlight`
...
4. Open the demo/preview: [http://localhost:8000/components/juicy-highlight/](http://localhost:8000/components/juicy-highlight/)
5. Open the test suite: [http://localhost:8000/components/juicy-highlight/test/](http://localhost:8000/components/juicy-highlight/test/)
